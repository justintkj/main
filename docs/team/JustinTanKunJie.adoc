...
User can choose from the list of valid command via the kbd:[&uarr;] or kbd:[&darr;] and select via kbd:[&enter;].
...
Autocomplete feature using JavaFX https://github.com/nus-cs2103-AY1718S1/forum/issues/122[#122]
